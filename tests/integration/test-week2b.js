...
// Load components
const ValueMatcher = require(path.join(__dirname, '../../src/analyzers/ValueMatcher'));
const ValueScorer = require(path.join(__dirname, '../../src/analyzers/ValueScorer'));
const EthicalProfiler = require(path.join(__dirname, '../../src/analyzers/EthicalProfiler'));
...
const testCorpus = JSON.parse(
    fs.readFileSync(path.join(__dirname, '../../iee-collaboration/from-iee/data/test-corpus-week2.json'), 'utf8')
);
